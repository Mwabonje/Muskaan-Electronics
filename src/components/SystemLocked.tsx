  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background-light p-4 font-display text-slate-900 relative">
      ...
      <div className="relative z-10 max-w-md w-full text-center space-y-6">
        ...
        <h1 className="text-4xl font-black tracking-tight text-slate-900">System Locked</h1>
        ...
        <div className="bg-white p-6 rounded-xl border border-rose-100 shadow-sm text-slate-600 space-y-4">
          ...
          <p>
            The system is currently locked due to pending maintenance fees or administrative action. 
            Please contact your system administrator or service provider to restore access.
          </p>
        </div>
